  ...
  return (
    <div className="bg-[#0a0a0a]">
      ...
      <section
        ...
        style={{ minHeight: 'var(--hero-min-h, auto)', background: '#0a0a0a', overflowX: 'clip' }}
      >
        <style>{`@media (min-width: 1024px) { :root { --hero-min-h: 100svh; } }`}</style>
        <div className="relative w-full">
          {/* Mobile layout: text over image */}
          <div className="lg:hidden relative" style={{ paddingTop: '16px', paddingBottom: '0' }}>
            ...
            <div className="relative px-5 pb-8">
              ...
              >
                <motion.div
                  ...
                  className="inline-flex items-center mb-4 font-inter text-[10px] font-semibold tracking-[0.13em] uppercase px-4 py-1.5"
                  style={{ border: '1px solid #D4AF37', color: '#D4AF37', borderRadius: '9999px', background: 'rgba(212,175,55,0.08)' }}
                >
                  <span className="inline-block w-1.5 h-1.5 rounded-full mr-2" style={{ background: '#D4AF37' }} />
                  Premium Research Peptides
                </motion.div>

                <h1 className="uppercase mb-3" style={{ letterSpacing: '0.01em' }}>
                  <span className="block font-barlow font-extrabold text-white" style={{ fontSize: '2.1rem', lineHeight: 1.0 }}>
                    RESEARCH-GRADE PEPTIDES.
                  </span>
                  <span className="block font-barlow font-extrabold" style={{ fontSize: '2.1rem', lineHeight: 1.0, color: '#D4AF37' }}>
                    LAB-VERIFIED PURITY.
                  </span>
                </h1>

                <p className="font-barlow font-semibold italic mb-6" style={{ fontSize: '1rem', color: 'rgba(255,255,255,0.55)' }}>
                  Revive Your Potential.
                </p>

                <Link
                  href="/shop"
                  className="font-inter inline-flex items-center gap-3 px-6 py-3.5 font-black text-sm uppercase tracking-widest transition-all duration-200"
                ...
                >
                  SHOP NOW
                  <span className="inline-flex items-center justify-center rounded-full" style={{ width: '20px', height: '20px', background: 'rgba(0,0,0,0.18)' }}>
            ...
            <motion.div
              ...
              className="flex items-center justify-center py-5 mx-5"
              style={{ borderTop: '1px solid rgba(255,255,255,0.08)' }}
            >
              {STATS.map((stat, i) => (
                <React.Fragment key={stat.label}>
                  {i > 0 && (
                    <div className="flex-shrink-0 mx-4" style={{ width: '1px', height: '28px', background: '#D4AF37', opacity: 0.4 }} />
                  )}
                  <div className="text-center">
                    <div className="font-barlow font-extrabold leading-none" style={{ fontSize: '1.4rem', color: '#D4AF37' }}>
                      {stat.value}
                    </div>
                    <div className="font-inter font-medium uppercase tracking-[0.12em] mt-1" style={{ fontSize: '9px', color: '#a0a0a0' }}>
                      {stat.label}
                    </div>
                  </div>
                </React.Fragment>
          ...
          <div className="hidden lg:block max-w-7xl mx-auto px-6 lg:px-12" style={{ paddingTop: '120px', paddingBottom: '80px' }}>
            <div className="grid grid-cols-[45%_55%] gap-0 items-center">
              ...
              >
                ...
                <h1 className="leading-[0.92] mb-4 uppercase" style={{ letterSpacing: '0.02em' }}>
                  <span className="block font-barlow font-extrabold text-white" style={{ fontSize: 'clamp(2.8rem, 6vw, 5.5rem)', lineHeight: 1.05 }}>
                    RESEARCH-GRADE PEPTIDES.
                  </span>
                  <span className="block font-barlow font-extrabold" style={{ fontSize: 'clamp(2.8rem, 6vw, 5.5rem)', lineHeight: 1.05, color: '#D4AF37' }}>
                    LAB-VERIFIED PURITY.
                  </span>
                </h1>

                <p className="font-barlow font-semibold italic mb-10" style={{ fontSize: 'clamp(1.1rem, 2vw, 1.45rem)', color: 'rgba(255,255,255,0.55)', letterSpacing: '0.01em' }}>
                  Revive Your Potential.
                </p>
            ...
            >
              {STATS.map((stat, i) => (
                <React.Fragment key={stat.label}>
                  ...
                  <div className="text-center">
                    <div className="font-barlow font-extrabold leading-none" style={{ fontSize: 'clamp(1.8rem, 3.5vw, 2.8rem)', color: '#D4AF37' }}>
                      {stat.value}
                    </div>
                    <div className="font-inter font-medium uppercase tracking-[0.15em] mt-1.5" style={{ fontSize: '11px', color: '#a0a0a0' }}>
                      {stat.label}
                    </div>
                  </div>
                </React.Fragment>
            ...
            <span key={setIdx} className="inline-flex items-center">
              {[
                ...
                <span key={i} className="inline-flex items-center">
                  <span
                    className="font-barlow font-black tracking-widest uppercase text-black"
                    style={{ fontSize: '12px', letterSpacing: '0.18em' }}
                  >
                    {item.text}
                  </span>
                  <span className="mx-5 text-black font-black" style={{ fontSize: '14px' }}>{item.icon}</span>
                </span>
              ))}
            </span>
          ))}
      ...
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-10 py-4 md:py-0 md:h-[60px] flex items-center justify-center">
          <div className="flex flex-col md:flex-row items-center gap-3 md:gap-0 w-full max-w-2xl">
            {[
              ...
              <React.Fragment key={item.text}>
                {i > 0 && (
                  <div className="hidden md:block flex-shrink-0 mx-6" style={{ width: '1px', height: '24px', background: 'rgba(255,255,255,0.12)' }} />
                )}
                <div className="flex items-center gap-2 flex-shrink-0">
                  <CheckCircle className="w-4 h-4 flex-shrink-0" style={{ color: '#D4AF37' }} />
                  <span className="font-inter text-sm font-medium" style={{ color: '#a0a0a0' }}>{item.text}</span>
                </div>
              </React.Fragment>
            ))}
          </div>
